...
All of the security issues, must be reported via [email](mailto:virk@adonisjs.com) and not using any of the public channels. [Learn more](https://github.com/adonisjs/adonis-framework/security/policy) about the security policy
